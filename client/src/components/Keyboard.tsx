...
export const Keyboard: React.FC<KeyboardProps> = ({ activeCode, correct, wrongCode, className, onModChange, target }) => {
  ...
  return (
    <div className={cn(
      "flex flex-col gap-4 py-6 px-16 rounded-[48px] border-[1.5px] border-slate-300 w-full max-w-[1600px] mx-auto backdrop-blur-sm relative shadow-sm transition-all duration-300",
