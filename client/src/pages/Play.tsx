...
export const Play: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 flex flex-col items-center pt-[9px] pb-[9px]" data-world={worldId} data-stage={stageId}>
      <HUD />
      {phase !== "result" && (
      ...
      <div className="container mx-auto px-4 flex flex-col items-center justify-start min-h-[60vh] pt-[0px] pb-[0px]">
        {phase === "intro" && (
